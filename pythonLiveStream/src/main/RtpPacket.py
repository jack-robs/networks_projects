...
################ Public methods #####################################
    def encapsulate(self, version: int, padding: int, extension: int, 
        ...
        # TODO: build check that ensures the bit values for each byte is within [0, 255]
...
#     # create object and encapsulate  
#     packet = RtpPacket()
#     packet.encapsulate(version, padding, extension, 
#                       contr_sources, marker, payload_type, 
#                       seq_num, sync_source_id, payload) 

#     print(packet.__str__()) # this should all be zero 
